...
git init
git add .
git commit -m "Source backup Fika Weapon Pickup Fix v1.1.0"
git branch -M main
...
`\\Servant\data\Games\EscapeFromTarkov4\CURSORAIMODING\releases\FikaWeaponPickupFix_v1.1.0_2026-07-06.zip`

```powershell
gh release create v1.1.0 "\\Servant\data\Games\EscapeFromTarkov4\CURSORAIMODING\releases\FikaWeaponPickupFix_v1.1.0_2026-07-06.zip" ^
  --title "Fika Weapon Pickup Fix v1.1.0" ^
